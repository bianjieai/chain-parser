...
const (
	...
	MsgTypeUnbondValidator             = "unbond_validator"
	MsgTypeValidatorBond               = "validator_bond"
	MsgTypeDisableTokenizeShares       = "disable_tokenize_shares"
	MsgTypeEnableTokenizeShares        = "enable_tokenize_shares"
	MsgTypeRedeemTokensForShares       = "redeem_tokens_for_shares"
	MsgTypeTokenizeShares              = "tokenize_shares"
	MsgTypeTransferTokenizeShareRecord = "transfer_tokenize_share_record"

	MsgTypeWithdrawAllTokenizeShareRecordReward = "withdraw_all_tokenize_share_record_reward"
	MsgTypeWithdrawTokenizeShareRecordReward    = "withdraw_tokenize_share_record_reward"
...
type (
	...
	MsgValidatorBond               = stake.MsgValidatorBond
	MsgUnbondValidator             = stake.MsgUnbondValidator
	MsgTokenizeShares              = stake.MsgTokenizeShares
	MsgDisableTokenizeShares       = stake.MsgDisableTokenizeShares
	MsgEnableTokenizeShares        = stake.MsgEnableTokenizeShares
	MsgRedeemTokensForShares       = stake.MsgRedeemTokensForShares
	MsgTransferTokenizeShareRecord = stake.MsgTransferTokenizeShareRecord
	...
	MsgWithdrawAllTokenizeShareRecordReward = distribution.MsgWithdrawAllTokenizeShareRecordReward
	MsgWithdrawTokenizeShareRecordReward    = distribution.MsgWithdrawTokenizeShareRecordReward
