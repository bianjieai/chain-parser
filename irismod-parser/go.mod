...
require (
	github.com/bianjieai/chain-parser/common-parser v0.0.0-20250513080810-0d6efedf494b
...
replace github.com/evmos/ethermint => github.com/bianjieai/ethermint v0.23.0-irishub
